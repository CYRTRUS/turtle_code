...
class ShapeGenerator:
    ...
    def run(self):
        while True:
            ...
            if choice == "1":
                self.draw_shape(30, 3, 1)  # 30 triangles, 1 layer each

            elif choice == "2":
                self.draw_shape(30, 4, 1)  # 30 squares, 1 layer each

            elif choice == "3":
                self.draw_shape(30, 5, 1)  # 30 pentagons, 1 layer each

            elif choice == "4":
                # Mix: 10 triangles, 10 squares, 10 pentagons, 1 layer each
                self.draw_shape(10, 3, 1)
                self.draw_shape(10, 4, 1)
                self.draw_shape(10, 5, 1)

            elif choice == "5":
                self.draw_shape(30, 3, 3)  # 30 triangles, 3 layers each

            elif choice == "6":
                self.draw_shape(30, 4, 3)  # 30 squares, 3 layers each

            elif choice == "7":
                self.draw_shape(30, 5, 3)  # 30 pentagons, 3 layers each

            elif choice == "8":
                # Mix with layers: 10 of each shape, 3 layers each
                self.draw_shape(10, 3, 3)
                self.draw_shape(10, 4, 3)
                self.draw_shape(10, 5, 3)
